...
<!-- Mirrored from htmlstream.com/preview/space-v2.3/page-customer-stories.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Oct 2022 07:42:18 GMT -->
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="hs-has-mega-menu nav-item" data-hs-mega-menu-item-options='{
              ...
              <!-- Mega Menu -->
              <div class="hs-mega-menu hs-position-right-fix dropdown-menu" aria-labelledby="landingsMegaMenu"
                ...
                <div class="navbar-dropdown-menu-inner">
                  <div class="row">
                    <div class="col-sm mb-3 mb-sm-0">
                      ...
                      <a class="dropdown-item " href="index-2.html">Corporate</a>
            ...
            <li class="hs-has-mega-menu nav-item">
              <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="#" role="button"
                aria-expanded="false">Pages</a>

              <!-- Mega Menu -->
              <div class="hs-mega-menu hs-position-right dropdown-menu w-100" aria-labelledby="pagesMegaMenu"
                ...
                <div class="navbar-dropdown-menu-inner">
                  <div class="row">
                    <div class="col-sm-6 col-md-3">
                      ...
                      <a class="dropdown-item active" href="page-customer-stories.html">Customer Stories</a>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 ms-3">
                      <span class="navbar-dropdown-menu-media-title">Documentation <span
                          class="badge bg-primary rounded-pill ms-1">v2.3</span></span>
            ...
            <!-- Log in -->
            <li class="nav-item">
              <a class="js-animation-link btn btn-ghost-secondary btn-no-focus me-2 me-lg-0" href="javascript:;"
                role="button" data-bs-toggle="modal" data-bs-target="#signupModal" data-hs-show-animation-options='{
            ...
            <!-- Sign up -->
            <li class="nav-item">
              <a class="js-animation-link d-none d-lg-inline-block btn btn-primary" href="javascript:;" role="button"
                data-bs-toggle="modal" data-bs-target="#signupModal" data-hs-show-animation-options='{
                           "targetSelector": "#signupModalFormSignup",
                           "groupName": "idForm"
                         }'>
    ...
    <div class="shape-container">
      <div class="bg-soft-warning position-relative overflow-hidden">
        <div class="container content-space-2 content-space-b-md-3">
          <div class="row justify-content-center align-items-lg-center mb-10">
            <div class="col-lg-12 mb-12 mb-lg-0">
              <div class="mb-7">
                <h1 class="display-3 text-primary">Visit great <span class="text-warning">companies</span></h1>
                <p class="lead">Check pass or <span class="text-warning">pre-register</span> a visit to top-companies.
                </p>
              </div>
              @if(Session::has('message'))
              <div class='alert alert-warning'>
                {{ Session::get('message') }}<br>
                Kindly copy your Pass Id.
                ...
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="row align-items-sm-center mb-5">
                      ...
                      <div class="col-sm">
                        <h5 class="card-title">Register/Login to begin...</h5>
                      </div>
                      <!-- End Col -->
                    </div>
                    <!-- End Row -->
                    <div id='register_show'>
                      <form method='post' action='{{ route("register") }}'>@csrf
                        ...
                        @endif
                        <div class="mb-4">
                          <label class="form-label" for="registerEmail">Full Name</label>
                          <input type="text" class="form-control form-control-lg" name="name" id="registerName"
                            placeholder="Type your name" aria-label="Type your name" required
                            data-msg="Please enter your name.">
                          <input type='hidden' value='visitor' name='user_type' />
                        </div>
                        ...
                        <div class="mb-4">
                          ...
                          <input type="number" class="form-control form-control-lg" name="phone" id="phone"
                            placeholder="Enter mobile number" aria-label="Mobile number" required
                        ...
                        <div class="d-grid text-center">
                          ...
                          <span class="form-text">Have an account? <a style='cursor:pointer' class="link"
                              id='login_show_btn'>Login <i class="bi-chevron-right small ms-1"></i></a></span>
                        </div>
                      </form>
                    </div>
                    <div id='login_show' style='display:none'>
                      <form method='post' action='{{ route("login") }}'>@csrf
                        ...
                        <div class="d-grid text-center">
                          ...
                          <span class="form-text">Yet to register? <a class="link" style='cursor:pointer'
                              id="register_show_btn">Register
                              Center
            ...
            <div class="row">
              <div class="col py-3">
                <img src="landing_assets/svg/brands/capsule-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="landing_assets/svg/brands/fitbit-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="landing_assets/svg/brands/vidados-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="landing_assets/svg/brands/mailchimp-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->

              <div class="col py-3">
                <img src="landing_assets/svg/brands/layar-primary.svg" alt="Logo" style="max-width: 7rem;">
              </div>
              <!-- End Col -->
            </div>
            <!-- End Row -->
          ...
          <!-- Background Shapes -->
          <div class="position-absolute top-0" style="left: 0rem;">
            <img src="landing_assets/svg/components/shape-1.svg" alt="SVG" width="500" style="width: 12rem;">
          </div>
          <div class="position-absolute" style="bottom: -5rem; right: 7rem;">
            <img src="landing_assets/svg/components/shape-7.svg" alt="SVG" width="150">
          </div>
      ...
      <!-- Blog List -->
      <div class="container content-space-t-1 content-space-t-md-3 mb-7">
        <div class="row align-items-md-center">
          <div class="col-md-6 order-md-2 mb-5 mb-md-0">
            <a href="https://www.youtube.com/watch?v=0qisGSwZym4" role="button" data-fslightbox="youtube-video">
              <div class="position-relative">
                <img class="img-fluid" src="landing_assets/img/950x950/img2.jpg" alt="Image Description">
          ...
          <div class="col-md-6">
            <div class="pe-md-5">
              ...
              <!-- Blockquote -->
              <figure class="mb-7">
                <blockquote class="blockquote blockquote-sm">“ Now that we’re using Space, everyone involved in a
                  project
                  has visibility into things like changes in scope and other status updates. “</blockquote>
              ...
              <img class="avatar avatar-xl avatar-4x3" src="landing_assets/svg/brands/mailchimp-primary.svg" alt="Logo">
            </div>
          </div>
          <!-- End Col -->
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img1.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/capsule-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Capsule scales at speed with
                    Space</a></h5>
                <p class="card-text">Capsule has turned payments into a competitive advantage working with Space,
                  allowing
                  it to scale at speed across multiple markets.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
            </div>
            <!-- End Card -->
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img4.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/fitbit-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">How Space supports Fitbit
                    transformation</a></h5>
                <p class="card-text">FitBit empowers marketers to create digital marketing dashboards easily and share
                  them with their team.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img5.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/hubspot-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Building the Perfect
                    Solution
                    for HubSpot</a></h5>
                <p class="card-text">Visitors can build a form or survey before signing up, but in order to save and
                  share
                  it, they need to create an account.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img6.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/google-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Google’s knowledge base
                    keeps
                    everyone informed and aligned</a></h5>
                <p class="card-text">Space’s ease of use is one of its hallmarks. It helps you visually navigate content
                  and remember where something is.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img7.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/embark-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Embark's operating system
                    drives remote collaboration</a></h5>
                <p class="card-text">Most task management apps — like Clickup or Trello — are just pointing to the work
                  that lives scattered in other places.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img8.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/amazon-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Space boosts Amazon’s
                    revenue
                    by 7%</a></h5>
                <p class="card-text">Going through a complete digital transformation is no easy task to do in 2020.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
                </a>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img9.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/kaplan-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                <h5 class="card-title"><a class="text-dark" href="page-customer-story.html">Kaplan scales at speed with
                    Space</a></h5>
                <p class="card-text">Kaplan has turned payments into a competitive advantage working with Space,
                  allowing
                  it to scale at speed across multiple markets.</p>
                <a class="card-link" href="page-customer-story.html">
                  View story <i class="bi-chevron-right small ms-1"></i>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img10.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/layar-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
          ...
          <div class="col-sm-6 col-lg-4 mb-7">
            ...
            <div class="card card-flush">
              <div class="card-pinned">
                <img class="card-img-top" src="landing_assets/img/600x400/img11.jpg" alt="Image Description">

                <div class="card-pinned-top-start">
                  <div class="bg-white rounded p-3">
                    <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/shopify-primary.svg"
                      alt="Logo">
                  </div>
                </div>
              </div>
          ...
          <div class="row col-sm-divider">
            <div class="col-sm-4">
              ...
              <div class="text-center p-3">
                <img class="img-fluid mb-5" src="landing_assets/svg/illustrations/oc-hi-five.svg"
                  alt="Image Description" style="height: 7rem;">
                <h4 class="h1 text-primary">45k+</h4>
            ...
            <div class="col-sm-4">
              <!-- Info -->
              <div class="text-center p-3">
                <img class="img-fluid mb-5" src="landing_assets/svg/illustrations/oc-review.svg" alt="Image Description"
                  style="height: 7rem;">
                <h4 class="h1 text-primary">8...</h4>
            ...
            <div class="col-sm-4">
              <!-- Info -->
              <div class="text-center p-3">
                <img class="img-fluid mb-5" src="landing_assets/svg/illustrations/oc-collaboration.svg"
                  alt="Image Description" style="height: 7rem;">
                <h4 class="h1 text-primary">12k+</h4>
      ...
      <div class="border-top mx-auto my-10" style="max-width: 25rem;"></div>

      <!-- Clients -->
      <div class="container content-space-b-1 content-space-b-md-3">
        <div class="text-center mx-auto" style="max-width: 35rem;">
          <div class="row justify-content-center">
            <div class="col text-center py-3">
              <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/fitbit-primary.svg" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col text-center py-3">
              <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/business-insider-primary.svg"
                alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col text-center py-3">
              <img class="avatar avatar-lg avatar-4x3" src="landing_assets/svg/brands/capsule-primary.svg" alt="Logo">
            </div>
            <!-- End Col -->
          </div>
          <!-- End Row -->
        ...
        <div class="container content-space-1 content-space-md-3">
          <div class="row justify-content-lg-between">
            <div class="col-md-5 col-lg-5 mb-5 mb-md-0">
              ...
              <p class="fs-6">Click below to access the Space API or join the Discord channel to share your solutions
                with
                the world</p>
            </div>
            <!-- End Col -->
              ...
              <form>
                ...
                <div class="input-card input-card-sm mb-3">
                  <div class="input-card-form">
                    <label for="requestDemoForm" class="form-label visually-hidden">Enter business email</label>
                    <input type="text" class="form-control" id="requestDemoForm" placeholder="Enter business email"
            ...
            <div class="d-grid gap-2">
              <a class="btn btn-white btn-lg" href="#">
                <span class="d-flex justify-content-center align-items-center">
                  <img class="avatar avatar-xss me-2" src="landing_assets/svg/brands/google-icon.svg"
                    alt="Image Description">
                  Log in with Google
                </span>
              </a>
          ...
          <div id="signupModalFormSignup">
            ...
            <div class="d-grid gap-3">
              ...
              <div class="text-center">
                <p class="small mb-0">By continuing you agree to our <a href="page-terms.html">Terms and Conditions</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer d-block text-center py-sm-5">
          ...
          <div class="w-85 mx-auto">
            <div class="row justify-content-between">
              <div class="col">
                <img class="img-fluid" src="landing_assets/svg/brands/gitlab-gray.svg" alt="Logo">
              </div>
              <!-- End Col -->

              <div class="col">
                <img class="img-fluid" src="landing_assets/svg/brands/fitbit-gray.svg" alt="Logo">
              </div>
              <!-- End Col -->

              <div class="col">
                <img class="img-fluid" src="landing_assets/svg/brands/flow-xo-gray.svg" alt="Logo">
              </div>
              <!-- End Col -->

              <div class="col">
                <img class="img-fluid" src="landing_assets/svg/brands/layar-gray.svg" alt="Logo">
              </div>
              <!-- End Col -->
            </div>
          </div>
  ...
  <script src="landing_assets/vendor/fslightbox/index.js"></script>
  ...
  <script>
    $('#register_show_btn').click(function() {
...
<!-- Mirrored from htmlstream.com/preview/space-v2.3/page-customer-stories.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Oct 2022 07:42:24 GMT -->
