                ...
                <div class="col-md-12 lg-12 sm-12">
                  ...
                  <article class="col-md-12 lg-12 sm-12"><a class="post-future-figure" href="#">
                    {{-- <img src="{{ asset('assets/images/news1.jpg') }}" alt="" width="368" height="287" /> --}}
                        @if($bet->image !== null)
                        {{-- <img src='{{ asset("contestPic/".$bet->image) }}' width="368" height="287"  alt='bet_image'> --}}
                        <img src='https://ctstake.com/ct_stake_files/public/contestPic/{{ $bet->image }}' width="368" height="287"  alt='bet_image'>
                ...
                <article class="game-result game-result-classic">
                  <div class="game-result-main">
                    ...
                    <div class="game-result-middle">
                      <div class="game-result-score-wrap justify-content-center">
                          <div class="game-result-score game-result-team-win">{{ $selection->title ?? '-' }}
                        ...
                        <div class="game-result-score game-result-team-win">{{ $selection->result ?? 'not concluded' }}
                            @if($selection->status == $selection->away)
                        
                            <span class="game-result-team-label game-result-team-label-top">Winner</span>
                            @endif
                  ...
                  <div class="game-result-footer">
                    <ul class="game-result-details">
                      <li>No Of Contestants: {{ $selection->no_of_contestants }}</li>
