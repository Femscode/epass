                    ...
                    <div class="task-list-section">
                                ...
                                <div class="connect-sorting-content" data-sortable="false">
                                    ...
                                    <div data-draggable="false" class="card img-task" style="">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Creating a new Portfolio on Dribble">Welcome, {{ $user->name }}</h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="task-body">
                                                ...
                                                <div class="task-bottom">
                                                    ...
                                                    <div class="tb-section-2">
                                                        <a class='btn btn-sm btn-success'>Edit Profile</a>
                                                        </div>
                                                </div>
                                    ...
                                    <div data-draggable="true" class="card simple-title-task" style="">
                                        <div class="row justify-content-center">
                                            <div class="card col-md-8 p-2 m-2"
                        ...
                        <div data-section="s-in-progress" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                ...
                                <div class="connect-sorting-content" @if($checkin->status == 'approved') data-sortable="true"  @else data-sortable="false"  @endif>

                                    <div @if($checkin->status == 'approved') data-draggable="true" @else data-draggable="false" @endif class="card task-text-progress" style="">
                                        <div class="card-body">

                                            <div class="task-header">
                                                
                                                <div class="">
                                                    <h4 class="" data-taskTitle="{{ $checkin->first_name }} - {{ $checkin->last_name }} ">{{ $checkin->first_name }} - {{ $checkin->last_name }} </h4>
                                                   <p><b>Pass Id:</b>
                                                    <input value='{{ $checkin->pass_id }}' class='form-control'/></p>
                                                </div>
                                                
                                                <div class="">
                                                    @if($checkin->status == 'approved')
                                               <a href='allow_visitor/{{ $checkin->uuid }}' class='btn btn-sm btn-success'>Approve</a>
                                               @endif
                                                </div>
                                            ...
                                            <div class="task-body">
                                                ...
                                                <div class="task-content">
                                                    ...
                                                    <div class="">
                                                        <div class="progress br-30">
                                                            <div class="progress-bar bg-primary" role="progressbar" data-progressState="50" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                ...
                                                <div class="task-bottom">
                                                    <div class="tb-section-1">
                                                        <span data-taskDate="{{ Date('d-m-Y',strtotime($checkin->created_at)) }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                                            {{ Date('d-m-Y',strtotime($checkin->expected_date)) }}</span>
                                                    </div>
                                                    <div class="tb-section-2">
                                                        <a href='view_checkin/{{ $checkin->uuid }}'><i class="far fa-eye"></i></a>
                                    ...
                                    <div @if($checkin->status == 'approved') data-draggable="true" @else data-draggable="false" @endif class="card task-text-progress" style="">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                               ...
                                               <a href='allow_visitor/{{ $checkin->uuid }}' class='btn btn-sm btn-danger'>Dissaprove</a>
                                               @endif
                                                </div>
