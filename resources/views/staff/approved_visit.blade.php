...
@section('content')
    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class='alert alert-success'>Visitor Disapproved Successfully</div>
            @endif
                ...
                <div class="col-lg-12 md-12 ">
                        ...
                        <div data-section="s-approved" class="col-lg-12 md-12 sm-12" data-connect="sorting">
                            ...
                            <div class="connect-sorting">
                                ...
                                <div class="col-md-4 lg-4 connect-sorting-content">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                ...
                                                <div class="">
                                                   ...
                                                   <p><b>Pass Id: <span style='color:red;font-size:15px'>{{ $checkin->pass_id }}</span></b>
                                               ...
                                               <a href='checkout/{{ $checkin->uuid }}' class='btn btn-sm btn-success'>Check User Out</a>
                                               @endif
                                                </div>
                                ...
                                <div class="add-s-task">
                                    {{ $approved->links('pagination::bootstrap-4') }}
